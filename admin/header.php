        ...
        <div class="d-flex align-items-center d-lg-none ms-n2 me-2" title="Show sidebar menu">
            <div class="btn btn-icon btn-active-color-primary w-35px h-35px" id="kt_app_sidebar_mobile_toggle">
                ...
                <span class="svg-icon svg-icon-1">
                    <img alt="Logo" src="../images-main/general/logo_2.png" class="h-30px" />
                </span>
                <!--end::Svg Icon-->
            </div>
        </div>
                            ...
                            <div data-kt-search-element="wrapper">
                                ...
                                <div class="mb-5" data-kt-search-element="main">
                                    <div class="d-flex flex-stack fw-semibold mb-4">
                                        <span class="text-muted fs-6 me-2">Relevant Results:</span>
                                    </div>
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
                        ...
                        <div class="menu-item px-3">
                            <div class="menu-content d-flex align-items-center px-3">
                                ...
                                <!--begin::Username-->
                                <div class="d-flex flex-column">
                                    <div class="fw-bold d-flex align-items-center fs-5"><?= $admin_name; ?></div>
                                    <a href="#" class="fw-semibold text-muted text-hover-primary fs-7"><?= $session_email; ?></a>
                                </div>
                                <!--end::Username-->
                            </div>
                        </div>
