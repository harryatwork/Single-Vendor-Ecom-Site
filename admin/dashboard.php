										...
										<div class="col-md-4 col-lg-4 col-xl-4 col-xxl-3 mb-md-5 mb-xl-10">
											<div class="card card-flush h-md-50 mb-xl-10" style="height: auto !important;">
												<div class="card-header pt-5">
													<div class="card-title d-flex flex-column">
														<div class="d-flex align-items-center">
															<span class="fs-2hx fw-bold text-dark me-2 lh-1 ls-n2 product_visit_count">
																<div class="loader"> 
																	<svg class="circular" viewBox="25 25 50 50">
																		<circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"/>
																	</svg> 
														...
														<span class="text-gray-400 pt-1 fw-semibold fs-6">Product So Far</span>
													</div>
												</div>
											</div>
										</div>
												...
												<div class="card-body d-flex justify-content-between flex-column pb-1 px-0">
													<div class="px-9 mb-5">
														<div class="d-flex mb-2">
															...
															<span class="fs-2hx fw-bold text-gray-800 me-2 lh-1 ls-n2 orders_total_this_month">
																<div class="loader"> 
																	<svg class="circular" viewBox="25 25 50 50">
																		<circle class="path" cx="50" cy="50" r="20" fill="none" stroke-width="2" stroke-miterlimit="10"/>
																	</svg> 
...
$(document).ready(function() {
	...
	product_visit_count("1=1","","views");
	orders_total_this_month("order_status='Confirmed' AND delivery_status='Delivered' AND date between '"+firstDay+"' and '"+lastDay+"'",'','price,quantity');
});
...
function product_visit_count(condition,limit,return_values) {
	$.post('backend/functions.php', {
		condition : condition,
		limit : limit,
		return_values : return_values,
		...
		for(let r=0;r<result.length;r++) {
			var visits_indi = 0;
			for(let r_=0;r_<result[0].length;r_++) {
				visits_indi = visits_indi+parseInt(result[r][r_]);
			}
			visits = visits + visits_indi;
		}
		$(".product_visit_count").html(visits);
	});
}

function orders_total_this_month(condition,limit,return_values) {
	$.post('backend/functions.php', {
		condition : condition,
		limit : limit,
		return_values : return_values,
		...
		$(".orders_total_this_month").html(total);
	});
}
